#!/usr/bin/env python3
"""Paced, credential-free direct readback of the public C140 C3 Zenodo record.

``--write`` performs exactly one logical public-record metadata fetch, then
downloads all 49 files sequentially over HTTPS.  Transient failures and HTTP
...
OUTPUT_RECEIPT = (
    ROOT
    / "00_control"
    / "ZENODO_DIRECT_READBACK_2026-08-29_C140_COMPANION_C3.json"
)

SCHEMA = "o006.c140.companion-c3.zenodo-direct-readback.v1"
...
USER_AGENT = "O006-C140-C3-Zenodo-direct-readback/2026.08.29"
PACE_SECONDS = 0.80
MAX_ATTEMPTS = 7
MAX_REDIRECTS = 4
...
def build_receipt() -> dict[str, object]:
    ...
    return {
        ...
        "verifier": {
            "path": "scripts/verify_zenodo_direct_c140_companion_c3.py",
