#!/usr/bin/env python3
"""Direct, anonymous byte readback for the public C140 companion C3 release.

This verifier deliberately does not call the GitHub API, read a credential
file, invoke Git, or launch a browser.  It derives the 49-asset expectation
from the local C3 package receipt and downloads each stable public release URL
...
OUTPUT_RECEIPT = (
    ROOT
    / "00_control"
    / "GITHUB_RELEASE_DIRECT_READBACK_2026-08-29_C140_COMPANION_C3.json"
)

SCHEMA = "o006.c140.companion-c3.github-release-direct-readback.v1"
...
TAG_OBJECT = "9a6fa0b27bd663e47e67d7f7b145f1da4f3ee6e3"
RELEASE_ID = 378_973_936
RELEASE_URL = f"{REPOSITORY}/releases/tag/{TAG}"

EXPECTED_FILE_COUNT = 49
EXPECTED_BYTES = 92_476_057
...
USER_AGENT = "O006-C140-C3-direct-release-readback/2026.08.29"
MAX_WORKERS = 4
...
def build_receipt() -> dict[str, object]:
    ...
    return {
        ...
        "expected_source": {
            "path": "build/C140_COMPANION_C3_RELEASE_PACKAGE_RECEIPT.json",
        ...
        "verifier": {
            "path": "scripts/verify_github_release_direct_c140_companion_c3.py",
